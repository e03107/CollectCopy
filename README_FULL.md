...
├── store_assets/         # ウェブストア用素材
├── CHROME_WEB_STORE.md   # ウェブストア掲載情報
└── SUBMISSION_GUIDE.md   # 提出ガイド
```
...
```bash
# ウェブストア提出用ZIPを作成
Compress-Archive -Path "manifest.json","popup.html","popup.css","popup.js","icons" -DestinationPath "CollectCopy.zip" -Force
```
